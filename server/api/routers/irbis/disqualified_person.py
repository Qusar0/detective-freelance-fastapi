...
@handle_route_errors("Неожиданная ошибка при получении дисквалифицированных лиц")
...
@handle_route_errors("Неожиданная ошибка при получении дела дисквалифицированного лица")
async def get_full_case_info(
    case_id: int,
    Authorize: AuthJWT = Depends(),
    db: AsyncSession = Depends(get_db),
):
    """Получает полную информацию о дисквалифицированном лице по ID."""
